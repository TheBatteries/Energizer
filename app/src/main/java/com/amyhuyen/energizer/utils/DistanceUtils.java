...
//        locationA.setLatitude(userLatLongArray[0]);
//        locationA.setLongitude(userLatLongArray[1]);
//
//        // set up second location
//        Location locationB = new Location("Opportunity Position");
//        locationB.setLatitude(oppLatLongArray[0]);
//        locationB.setLongitude(oppLatLongArray[1]);
//
